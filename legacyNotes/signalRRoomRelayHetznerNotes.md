...
```bash
cd /var/www/signalr-room-relay && git pull origin main && cd backend-dotnet && rm -rf out-new && dotnet publish -c Release -o out-new && pm2 stop signalr-room-relay && rm -rf out && mv out-new out && cd out && pm2 restart signalr-room-relay && sleep 3 && echo -e "\nHealth check:" && curl https://signalr-room-relay.portfolio-projects.space/health && echo ""

```
pm2 logs signalr-room-relay --lines 50
pm2 flush signalr-room-relay

test page: https://signalr-room-relay.portfolio-projects.space/test-signalr.html